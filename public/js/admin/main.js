            ...
            resolve: {
                deps: ['$ocLazyLoad', function($ocLazyLoad) {
                    return $ocLazyLoad.load([{
                        ...
                        name: 'MetronicApp',
                        files: [
                            'js/admin/controllers/GeneralPageController.js'
                        ]
                    }]);
                }]
            }
            ...
            resolve: {
                deps: ['$ocLazyLoad', function($ocLazyLoad) {
                    return $ocLazyLoad.load([{
                        ...
                        name: 'MetronicApp',
                        files: [
                            'js/admin/controllers/UISelectController.js'
                        ] 
                    }]);
                }]
            }
                ...
                deps: ['$ocLazyLoad', function($ocLazyLoad) {
                    return $ocLazyLoad.load([{
                        ...
                        files: [
                            ...
                            'metronic/assets/pages/scripts/ui-tree.min.js',
                            'js/admin/controllers/GeneralPageController.js'
                        ] 
                    }]);
                }] 
                ...
                deps: ['$ocLazyLoad', function($ocLazyLoad) {
                    return $ocLazyLoad.load([{
                        ...
                        files: [
                            ...
                            'metronic/assets/pages/scripts/components-form-tools-2.min.js',
                ...
                deps: ['$ocLazyLoad', function($ocLazyLoad) {
                    return $ocLazyLoad.load([{
                        ...
                        files: [
                            ...
                            'metronic/assets/pages/scripts/components-date-time-pickers.min.js',
                ...
                deps: ['$ocLazyLoad', function($ocLazyLoad) {
                    return $ocLazyLoad.load([{
                        ...
                        files: [
                            ...
                            'metronic/assets/pages/scripts/components-bootstrap-select.min.js',
                            'metronic/assets/pages/scripts/components-select2.min.js',
                ...
                deps: ['$ocLazyLoad', function($ocLazyLoad) {
                    return $ocLazyLoad.load({
                        ...
                        files: [                             
                            ...
                            'metronic/assets/global/plugins/datatables/datatables.all.min.js',

                            'metronic/assets/pages/scripts/table-datatables-managed.min.js',
                ...
                deps: ['$ocLazyLoad', function($ocLazyLoad) {
                    return $ocLazyLoad.load({
                        ...
                        files: [
                            ...
                            'metronic/assets/pages/scripts/profile.min.js',

                            'js/admin/controllers/UserProfileController.js'
                        ]                    
                    });
                }]
            }
                ...
                deps: ['$ocLazyLoad', function($ocLazyLoad) {
                    return $ocLazyLoad.load({ 
                        ...
                        files: [
                            ...
                            'js/admin/controllers/TodoController.js'  
                        ]                    
                    });
                }]
            }
