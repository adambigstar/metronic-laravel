...
<head>
  ...
  <link href="metronic/assets/global/css/components.min.css" id="style_components" rel="stylesheet" type="text/css" />
...
<script src="metronic/assets/global/plugins/angular-animate/angular-animate.min.js" type="text/javascript"></script>
<script src="metronic/assets/global/plugins/angular-aria/angular-aria.min.js" type="text/javascript"></script>
<script src="metronic/assets/global/plugins/angular-loader/angular-loader.min.js" type="text/javascript"></script>
<script src="metronic/assets/global/plugins/angular-messages/angular-messages.min.js" type="text/javascript"></script>
<script src="metronic/assets/global/plugins/angular-mocks/angular-mocks.js" type="text/javascript"></script>
<script src="metronic/assets/global/plugins/angularjs/plugins/angular-ui-router.min.js" type="text/javascript"></script>
<script src="metronic/assets/global/plugins/angularjs/plugins/ocLazyLoad.min.js" type="text/javascript"></script>
<script src="metronic/assets/global/plugins/angularjs/plugins/ui-bootstrap-tpls.min.js" type="text/javascript"></script>
<script src="metronic/assets/global/plugins/satellizer/dist/satellizer.min.js" type="text/javascript"></script>
<!-- END CORE ANGULARJS PLUGINS -->
<!-- BEGIN APP LEVEL ANGULARJS SCRIPTS -->
<script src="js/admin/main.js" type="text/javascript"></script>
<script src="js/admin/directives.js" type="text/javascript"></script>
<script src="js/admin/authjwt.js" type="text/javascript"></script>
